...
As you can see, calculations of 4 ¡Á 3 and 6 ¡Á 2 are not necessary. Therefore, we only need to consider factors up to &radic;n because, if n is divisible by some number p, then n = p ¡Á q and since p &le; q, we could derive that p &le; &radic;n.
